#manualmente fazendo a mineiração para futuramente realizar aplicação em naive bayes + base de dados maior + avaliação do código com nltk
#lembrando de utilizar as base de dados de treinamento e a de teste (tem que ser diferente)
...
frases = aplica_stemmer(basetreinamento)
#print(frases)
...
basecompleta = nltk.classify.apply_features(extratorpalavras, frases)
#print(basecompleta)

classifica = nltk.NaiveBayesClassifier.train(basecompleta)
#print(classifica.labels())
#print(classifica.show_most_informative_features(10))

teste = "Você me faz uma pessoa infeliz!"
testestemming = []
stemmer = nltk.stem.RSLPStemmer()
...
print(classifica.classify(novo))


distribuicao = classifica.prob_classify(novo)
